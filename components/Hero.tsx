      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        />
          ...
          <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
            We want to be on each of your journeys seeking the satisfaction of seeing incorruptible beauty of nature.we can help you on an adventure around the world in just one app
          </p>
          ...
          <div className="flex flex-col">
              ...
              <div className="flexBetween">
                  <div className="flex flex-col">
                      ...
                      <p className="bold-20 text-white">178.23 mi</p>
                    </div>            
                  <div className="flex flex-col">
